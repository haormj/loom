...
pub use schema::{
    ...
    Group, ItemEntry, LanguageReference, LanguageRule, ManifestRule, PrependItem, ProviderOverlay,
    ReferenceCatalog, ReferenceItemRule, RepoSignalsConfig, Route, SectionGroupMapping,
    SelectionRule, SourceRootsConfig,
};
pub use vendor::{
