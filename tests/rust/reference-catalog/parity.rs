...
fn deploy_route_refids_paths_and_reasons_match_reference_metadata() {
    ...
    let expected = [
        ...
        (
            "deploy.compose",
            "compose.md",
            "Compose 服务编排、端口、依赖与健康检查指导。",
        ),
        (
            "deploy.dockerfile",
            "dockerfile.md",
            "Dockerfile 上下文、工作目录、复制、构建与运行时指导。",
        ),
        (
            "deploy.environment",
            "environment.md",
            "环境、本地默认值、依赖 URL 与状态指导。",
        ),
        (
            "deploy.workspaces",
            "workspaces.md",
            "工作区应用路径、源码根目录与构建上下文指导。",
        ),
        (
            "deploy.bootstrap",
            "bootstrap.md",
